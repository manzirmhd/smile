...
import BigComm from '../pages/BigComm'
    ...
    <div className='py-10 px-10'>
        ...
        <div className='pt-20  border-b-2 flex justify-center items-center w-screen'>
            <ul className='flex w-max'>
                ...
                <li className='bg-slate-100 border rounded-t-md border-l-0 border-gray-300' ><Link to={<BigComm/>}><div className='py-5 px-10'><img src='/src/assets/bigcom.png' alt='commerce' className='h-7'/></div></Link></li>
