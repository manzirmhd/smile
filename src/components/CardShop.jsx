...
function CardShop(props) {
    const {heading, paragraph_one, paragraph, paragraph_two} = props
  return (
    <div className='flex justify-center items-center pb-10'>
      ...
      <div className="px-6 py-4">
        ...
        <div className='flex'>
        <p className="text-black text-3xl font-bold mb-1">{paragraph_one}</p>
        <p className="text-gray-700 text-base">/month</p>
        </div>
        <p className="text-gray-700 text-xs mb-5 w-40">{paragraph_two}</p>
